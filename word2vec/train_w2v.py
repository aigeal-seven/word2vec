...
# train model
# model = Word2Vec(sentences, size=100, window=5, min_count=1, workers=8,iter = 20)
# next training method
model = Word2Vec(sentences, min_count=2, window=5, sample=6e-5,
                 alpha=0.03, min_alpha=0.007, workers=8)
...
# save model
model.save(model_path+'/newword2vec')
